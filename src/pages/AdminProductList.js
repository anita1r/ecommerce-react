            ...
            <main className="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in pl-64">
                ...
                <div className="main-content flex flex-col flex-grow p-4">
                    <div className="flex justify-between md:mx-10 mb-4 items-center">
                        ...
                        <button type="button" onClick={createProductHandler} className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">+ Create Product</button>
                    </div>
                    {/* table */}
