                ...
                <aside className = "hidden lg:block border-x-4 sticky self-start  top-4 w-1/5">
                    <form >
                        ...
                        <div className="space-y-2 mx-12 my-6">
                            ...
                            <div className=''>
                                <div className="mb-6">
                                    <label for="base-input" className="block mb-2 text-sm font-medium text-gray-900 ">Min Price</label>
                                    <input type="text" id="base-input" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "  onChange={(e)=> setMinPrice(e.target.value)}/>
                                </div>
                                <div className="mb-6">
                                    <label for="base-input" className="block mb-2 text-sm font-medium text-gray-900 ">Max Price</label>
                                    <input type="text" id="base-input" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "  onChange={(e)=> setMaxPrice(e.target.value)} />
                                </div>
                            </div>
                        </div>
                        <div className="space-y-2 mx-12 my-6">
                        ...
                        <div className="space-y-2 mx-12 my-6">
                            <button type="submit" className="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ">Apply Filters</button>
                        </div>
                    </form>
                </aside>
