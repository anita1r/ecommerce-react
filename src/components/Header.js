    ...
    return (
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
          ...
          <div className="flex">
          {/* <button type="button" className="text-white bg-green-500 hover:bg-green-300 focus:ring-4 focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
        ...
        <div className="flex items-center justify-center -mx-4 lg:pl-8">
          <div className="flex flex-col items-end px-3">
            <img
              ...
              src="/images/product-images/laptop.jpg"
              alt=""
            />
            <img
              className="object-cover w-20 h-20 rounded shadow-lg sm:h-32 xl:h-40 sm:w-32 xl:w-40"
              src="/images/product-images/alexa.jpg"
              alt=""
            />
          </div>
          <div className="px-3">
            <img
              ...
              src="/images/product-images/Headset.jpg"
              alt=""
            />
          </div>
        </div>
