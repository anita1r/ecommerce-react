            ...
            <div className="h-16 flex items-center justify-between lg:justify-evenly">
              ...
              <div className="lg:hidden ml-4 flex items-center lg:ml-0">
                <a href="/">
                  ...
                  <h1 className="lora-font font-bold text-2xl">Best Store</h1>
                </a>
              </div>
              ...
              <Popover.Group className="hidden lg:ml-8 lg:block lg:self-stretch">
                <div className="h-full flex space-x-8">
                  <Link to="/">
                  <h1 className="font-bold text-2xl mt-4">Best Store</h1>
                  </Link>
                  {navigation.categories.map((category) => (
            ...
            <Search/>
              ...
              <div className=" flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {
                    userInfo ?
                    <button type="button" onClick={logoutHandler} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Logout</button>
                    :
                    <Link to="/login">
                    <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign In</button>
                    </Link>
                  }
                </div>
